...
/**
 * Builder for ChannelDropdownQuestion
 */
@Accessors(chain = true, fluent = true)
@Getter @Setter
public class ChannelDropdownBuilder {

  public static BiPredicate<List<GuildChannel>, Form> DEFAULT_INPUT_VALIDATOR = (s, form) -> true;
  public static Function<List<GuildChannel>, MessageCreateData> DEFAULT_VALIDATION_MESSAGE = DefaultMessageCreateDatas.objectValidationError();
   ...
   */
  private @NonNull BiPredicate<List<GuildChannel>, Form> inputValidator = DEFAULT_INPUT_VALIDATOR;

  /**
   * Message the user receives after inputting an invalid value
   */
  private @NonNull Function<List<GuildChannel>, MessageCreateData> invalidInputMessage = DEFAULT_VALIDATION_MESSAGE;
   ...
   */
  public ChannelDropdownQuestion build() {
    ChannelDropdownQuestion question = new ChannelDropdownQuestion();
