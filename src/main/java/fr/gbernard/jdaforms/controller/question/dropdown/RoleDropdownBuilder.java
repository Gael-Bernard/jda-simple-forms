...
public class RoleDropdownBuilder {
  ...
  public static BiPredicate<List<Role>, Form> DEFAULT_INPUT_VALIDATOR = (s, form) -> true;
  public static Function<List<Role>, MessageCreateData> DEFAULT_VALIDATION_MESSAGE = DefaultMessageCreateDatas.objectValidationError();
   ...
   */
  private @NonNull BiPredicate<List<Role>, Form> inputValidator = DEFAULT_INPUT_VALIDATOR;

  /**
   * Message the user receives after inputting an invalid value
   */
  private @NonNull Function<List<Role>, MessageCreateData> invalidInputMessage = DEFAULT_VALIDATION_MESSAGE;
